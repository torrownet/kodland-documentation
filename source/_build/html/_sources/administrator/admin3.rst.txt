...
Чтобы настроить нового **Методиста индивидуальных мастер-классов**, необходимо создать в приложении Torrow ресурс типа **Аренда**.
...
Создание ресурса **Методист индивидуальных мастер-классов**:

1. Зайдите в **элемент**, который является хранилищем всех ресурсов типа **МИМК**.

.. figure:: media/new_mimk1.png
    :scale: 42 %
    :alt: alternate text
    :align: center
...
.. list-table:: Параметры услуги для проведения мастер-классов
   ...
   * - Контакт
     - Указать визитку реального методиста
...
Подробная инструкция по настройке методиста индивидуальных мастер-классов
-------------------------------------------------------------------------
