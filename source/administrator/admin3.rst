==============================================================
Настройка нового Консультанта
==============================================================


Чтобы настроить нового **Консультанта**, необходимо создать в приложении Torrow ресурс типа **Аренда**.
...
Создание ресурса **Консультант**:

1. Зайдите в **элемент**, который является хранилищем всех ресурсов типа **Консультант**.
...
Подробная инструкция по настройке Консультанта
-------------------------------------------------------------------------

Чтобы настроить ресурс **Консультант**:
...
8. В строке поиска введите нужный контакт, который и будет являться **Консультантом**.
...
18. Выберите **Консультант** и нажмите |галка|.
